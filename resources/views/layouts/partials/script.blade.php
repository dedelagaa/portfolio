<script src="{{ asset('assets/vendor/jquery/js/jquery.min.js') }}"></script> <!-- jquery JS (https://jquery.com) -->
<script src="{{ asset('assets/vendor/jquery/js/jquery-ui.min.js') }}"></script> <!-- jquery UI JS (https://jquery.com) -->
<script src="{{ asset('assets/vendor/bootstrap/js/bootstrap.min.js') }}"></script> <!-- bootstrap JS (http://getbootstrap.com) -->

<!-- Libs and Plugins JS -->
<script src="{{ asset('assets/vendor/pace.min.js') }}"></script> <!-- Pace (page loader) JS (http://github.hubspot.com/pace/docs/welcome/) -->
...
<script src="{{ asset('assets/vendor/magnific-popup/js/jquery.magnific-popup.min.js') }}"></script> <!-- Magnific Popup JS (http://dimsemenov.com/plugins/magnific-popup/) -->
