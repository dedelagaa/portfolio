		...
		<link rel="stylesheet" type='text/css' href="{{ asset('assets/vendor/bootstrap/css/bootstrap.min.css') }}"> <!-- bootstrap CSS (http://getbootstrap.com) -->

		<!-- Libs and Plugins CSS -->
		<link rel="stylesheet" href="{{ asset('assets/vendor/jquery/css/jquery-ui.min.css') }}"> <!-- jquery UI CSS (https://jquery.com) -->
		...
		<link rel="stylesheet" href="{{ asset('assets/vendor/magnific-popup/css/magnific-popup.css') }}"> <!-- Magnific Popup CSS (http://dimsemenov.com/plugins/magnific-popup/) -->
